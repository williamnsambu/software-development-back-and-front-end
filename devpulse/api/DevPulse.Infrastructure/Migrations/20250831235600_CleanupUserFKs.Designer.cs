...
namespace DevPulse.Infrastructure.Migrations
{
    ...
    [Migration("20250831235600_CleanupUserFKs")]
    partial class CleanupUserFKs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevPulse.Domain.Entities.Issue", b =>
                {
                    b.HasOne("DevPulse.Domain.Entities.Repository", "Repo")
                        .WithMany("Issues")
                        .HasForeignKey("RepoId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("DevPulse.Domain.Entities.User", "User")
                        .WithMany()
